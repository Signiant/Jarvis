...
def get_superjenkins_data(beginning_script_tag, ending_script_tag, superjenkins_link=None, superjenkins_key=None):
    ...
    # if call to s3 bucket to receive super jenkins data fails than call local super jenkins_link
    if superjenkins_key:
        try:
            ...
            json_body = obj.get()['Body'].read().decode('utf8')
            ...
            logging.info("Super jenkins data retrieved and json loaded")
